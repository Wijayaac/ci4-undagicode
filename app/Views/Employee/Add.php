        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Add Empployee</h5>
                ...
                <form method="post" id="formAdd" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="employeeName" class="form-control" id="inputName" required>
                            <span id="errorName" class="text-danger small"></span>
                        </div>
                        <!-- Field Address type textarea (include tinyMCE) -->
                        <div class="form-group">
                            <label for="textbox">Address</label>
                            <textarea class="form-control" name="employeeAddress" id="inputAddress" rows="2"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="employeePhone" class="form-control" id="employeePhone" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="employeeEmail" class="form-control" id="inputEmail" placeholder="name@example.com">
                    ...
                    <div class="modal-footer">
                        <button id="addEmployee" class="btn btn-success">Save</button>
